...
public class GetHighscore : MonoBehaviour
{
    ...
    void Start(){
      currentTime = PlayerPrefs.GetFloat("highScoreGameSave");
      time = TimeSpan.FromSeconds(currentTime);
      currentTime2 = PlayerPrefs.GetFloat("highScoreGameSave2", 9999999);
      ...
      currentTime3 = PlayerPrefs.GetFloat("highScoreGameSave3", 9999999);
